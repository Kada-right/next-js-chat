  ...
  return (
    <>
      <section className="m-4">
        ...
        <p className="py-2">
          Layouts define the structure of a page or component. Below are
          examples of the layouts used in this project, along with descriptions
      ...
      <section className="m-4">
        ...
        <p className="mt-2">
          Here are the layout styles defined in the project along with their
        ...
        {layouts.map((layout) => (
          <div key={layout.name} className="border-b border-gray-300 py-4">
            <div
              ...
              style={{
                height: layout.name === "Centered Layout" ? "160px" : "auto",
              }}
            >
